...
export default function AdminPage() {
  ...
  // Busy flags for per-product add-on linking toggles
  const [busyAddonToggle, setBusyAddonToggle] = useState<
      ...
      <main className="flex-1 md:ml-72 min-w-0 pb-20 md:pb-0 h-screen overflow-y-auto">
        ...
        <div className="md:hidden bg-white border-b p-4 flex items-center justify-between sticky top-0 z-30 shadow-sm shrink-0">
          ...
          <button
            ...
            className="p-2 -mr-2 text-slate-600 hover:bg-gray-100 rounded-lg"
          >
              ...
              <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                ...
                >
                  <input
                    ...
                    className="border border-gray-200 bg-gray-50 p-3 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all"
                    required
                  />
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 bg-gray-50 p-3 pl-7 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all"
                      required
                    />
                  </div>
                  <div className="relative">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between border border-gray-200 bg-gray-50 p-3 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all ${!selectedCategoryId ? "text-gray-400" : "text-gray-800"}`}
                    >
                      <span>
                        {selectedCategoryId
                        ...
                        <div className="absolute z-20 mt-2 w-full bg-white border border-gray-100 rounded-xl shadow-xl max-h-60 overflow-y-auto animate-in fade-in zoom-in-95 duration-100">
                          {data.categories.map((c) => (
                            <button
                              ...
                              className="w-full text-left px-4 py-3 hover:bg-red-50 hover:text-red-600 transition-colors flex items-center justify-between first:rounded-t-xl last:rounded-b-xl"
                            >
                  ...
                  <input
                    ...
                    className="border border-gray-200 bg-gray-50 p-3 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all md:col-span-2"
                  />
                  <button className="bg-slate-900 text-white py-3 rounded-xl font-bold md:col-span-2 hover:bg-slate-800 hover:shadow-lg transition-all active:scale-[0.99] text-base">
                    Create Product
                  </button>
                </form>
              </div>
                ...
                <div className="divide-y">
                  {data.products.map((product) => (
                    <Fragment key={product.id}>
                      <div
                        className={`transition-colors ${!product.is_active ? "bg-gray-50/50" : "hover:bg-gray-50"}`}
                      >
                        ...
                        <div className="p-4 flex flex-col md:grid md:grid-cols-[50px_2fr_1fr_auto] gap-4 items-center">
                          ...
                          <div className="w-full md:w-auto flex justify-between md:block items-center">
                            ...
                            <div className="md:hidden text-sm text-gray-500 max-w-[150px] truncate">
                              {product.description}
                            </div>
                          </div>
                          ...
                          <div className="w-full md:w-auto flex items-center justify-between md:justify-end gap-3 mt-2 md:mt-0 pt-3 md:pt-0 border-t md:border-0 border-dashed">
                            ...
                            <button
                              ...
                              className="p-2 text-red-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-2"
                            >
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                  ...
                                  {product.variants?.map((v) => (
                                    <div
                                      key={v.id}
                                      className="group md:grid md:grid-cols-[1fr_1fr_100px_auto] gap-2 items-center bg-gray-50 md:bg-white p-3 md:p-0 rounded-xl md:rounded-none border md:border-0 md:border-b md:pb-2 last:border-0"
                                    >
                                      {editingVariantId === v.id ? (
                                        <>
                                          <div className="mb-2 md:mb-0">
                                            <label className="text-[10px] uppercase font-bold text-gray-400 md:hidden block mb-1">
                                              Option
                                            </label>
                                            <input
                                              form={`form-${v.id}`}
                                              name="size"
                                              defaultValue={v.size}
                                              className="border border-blue-300 rounded-lg p-2 w-full text-sm bg-blue-50 focus:bg-white"
                                            />
                                          </div>
                                          <div className="mb-2 md:mb-0">
                                            <label className="text-[10px] uppercase font-bold text-gray-400 md:hidden block mb-1">
                                        ...
                                        <>
                                          <div className="flex justify-between md:block mb-1 md:mb-0">
                                            <span className="md:hidden text-xs text-gray-400 font-bold uppercase">
                                              Option
                                            </span>
                                ...
                                <div className="bg-slate-50 p-4 rounded-xl border border-dashed border-slate-200 mt-4">
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      className="flex-1 border border-gray-200 rounded-lg p-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-200"
                                      required
                                    />
                                    <input
                                      name="crust"
                                    ...
                                    <input
                                      ...
                                      type="number"
                                      placeholder="Cents"
                                      className="w-full md:w-24 border border-gray-200 rounded-lg p-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-200"
                                      required
                                    />
                                    <button className="bg-slate-900 text-white px-4 py-2.5 rounded-lg text-sm font-bold hover:bg-slate-800 transition-colors">
                                      Add
                                    </button>
                                  </form>
                                </div>
                              ...
                              <div className="space-y-2">
                                {(!data.addonGroups ||
                                  ...
                                  <div className="text-sm text-gray-400 italic text-center py-4 bg-gray-50 rounded-xl">
                                    No add-ons created. Go to 'Add-ons' tab.
                                  </div>
                                )}
                                {(data.addonGroups || []).map((group) => {
                                  const linkedIds = new Set<string>(
                                    (product.product_addon_groups || [])
                                      .map(
                                        (pag: any) =>
                                          pag.group_id ??
                                          pag.addon_groups?.id ??
                                  ...
                                  const busyKey = `${product.id}:${group.id}`;
                                  const isBusy = !!busyAddonToggle[busyKey];

                                  return (
                                    <label
                                      key={group.id}
                                      className={`flex items-center justify-between p-3.5 border rounded-xl cursor-pointer transition-all ${isLinked ? "bg-orange-50 border-orange-200 shadow-sm" : "hover:bg-gray-50 border-gray-100"} ${isBusy ? "opacity-60 pointer-events-none" : ""}`}
                                    >
                                      <div className="flex items-center gap-3">
                                        <div
                                          className={`w-5 h-5 rounded-md border flex items-center justify-center transition-colors ${isLinked ? "bg-orange-500 border-orange-500" : "bg-white border-gray-300"}`}
                                        >
                                          {isLinked && (
                                        ...
                                        <input
                                          ...
                                          onChange={async (e) => {
                                            ...
                                            try {
                                              setBusyAddonToggle((prev) => ({
                                                ...prev,
                                                [busyKey]: true,
                                              }));
                                              await toggleProductAddonGroup(
                                                product.id,
                                                group.id,
                                                checked,
                                              );
                                              ...
                                              console.error(
                                                "Failed to update add-on link",
                                                err,
                                              );
                                              alert(
                                                "Failed to update add-ons. Please try again.",
                                              );
                                            } finally {
                                              setBusyAddonToggle((prev) => {
                                                const next = { ...prev };
                                        ...
                                        <div>
                                          <div
                                            className={`font-bold text-sm ${isLinked ? "text-orange-900" : "text-gray-700"}`}
                                          >
                                            {group.name}
                                          </div>
                                      ...
                                      <div className="text-[10px] font-bold bg-white/50 px-2 py-1 rounded-md text-gray-500 border border-gray-100">
                                        {group.addons?.length || 0} items
                                      </div>
                                    </label>
                                  );
                                })}
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                >
                  <div className="w-full md:flex-1 min-w-[200px]">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 bg-gray-50 p-2.5 rounded-xl text-base md:text-sm focus:bg-white outline-none focus:ring-2 focus:ring-slate-200"
                      required
                    />
                  </div>
                  ...
                  <div className="w-full md:w-36 relative">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-gray-500 transition-transform ${isAddonTypeOpen ? "rotate-180" : ""}`}
                      />
                    </button>
                    {isAddonTypeOpen && (
                      <>
                        <div
                          className="fixed inset-0 z-10"
                          onClick={() => setIsAddonTypeOpen(false)}
                        />
                  ...
                  <div className="pb-3 flex items-center gap-2 w-full md:w-auto">
                    <input
                      ...
                      name="is_required"
                      id="req"
                      className="w-5 h-5 md:w-4 md:h-4 text-red-600 rounded focus:ring-red-600"
                    />
                    <label
                      htmlFor="req"
                  ...
                  <button
                    type="submit"
                    className="w-full md:w-auto bg-slate-900 text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-slate-800 transition-colors"
                  >
                    Create
                  </button>
                </form>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {(data.addonGroups || []).map((group) => (
                  <div
                    key={group.id}
                    className="bg-white border rounded-3xl shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-shadow"
                  >
                    <div className="p-4 border-b bg-gray-50/80 flex justify-between items-start">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          <span className="text-[10px] uppercase font-extrabold bg-blue-100 text-blue-700 px-2 py-1 rounded-lg tracking-wide">
                            {group.type}
                          </span>
                          ...
                          {group.is_required && (
                            <span className="text-[10px] uppercase font-extrabold bg-red-100 text-red-700 px-2 py-1 rounded-lg tracking-wide">
                              Req
                            </span>
                          )}
                        </div>
                    ...
                    <div className="p-4 flex-1 flex flex-col gap-3">
                      {group.addons?.map((addon) => (
                        <div
                          key={addon.id}
                          className="flex justify-between items-center text-sm p-3 bg-gray-50 rounded-xl border border-transparent hover:border-gray-200 transition-all"
                        >
                      ...
                      {(!group.addons || group.addons.length === 0) && (
                        <div className="text-xs text-gray-400 italic text-center py-4 bg-gray-50 rounded-xl border border-dashed">
                          No items yet
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-3 bg-gray-50 border-t mt-auto">
                      ...
                      >
                        ...
                        <input
                          ...
                          className="flex-1 text-xs border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-100 bg-white"
                          required
                        />
                        <input
                          name="price"
                          type="number"
                          placeholder="Cents"
                          className="w-16 text-xs border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-100 bg-white"
                          required
                        />
                        <button className="bg-white border hover:bg-slate-900 hover:text-white text-slate-700 px-3 rounded-lg text-xs font-bold transition-colors shadow-sm">
                          +
                        </button>
                      </form>
                    </div>
              ...
              {(!data.addonGroups || data.addonGroups.length === 0) && (
                <div className="text-center py-16 text-gray-400 bg-white rounded-3xl border-2 border-dashed flex flex-col items-center justify-center">
                  ...
                  <p className="text-sm mt-1 text-gray-400">
                    Create one above to start upselling toppings, sides, or
                    drinks.
                  </p>
                </div>
              )}
              ...
              <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                ...
                >
                  <input
                    ...
                    className="flex-1 border border-gray-200 bg-gray-50 p-3 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all"
                    required
                  />
                  <button className="bg-slate-900 text-white px-6 py-3 rounded-xl text-sm font-bold hover:bg-slate-800 transition-all">
                    Add
                  </button>
                </form>
              </div>
                  ...
                  {data.categories.map((cat, index) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <span className="font-medium text-slate-800 text-lg md:text-base">
                          {cat.name}
                        </span>
                      </div>
                      <button
          ...
          {activeTab === "Settings" && data && (
            <div className="max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                ...
                >
                  <div>
                    <label className="block text-sm font-bold text-gray-500 uppercase mb-2 ml-1">
                      Restaurant Name
                    </label>
                    <input
                      name="name"
                      defaultValue={data.settings.name}
                      className="w-full border border-gray-200 bg-gray-50 p-3 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        defaultValue={data.settings.delivery_fee_cents}
                        className="w-full border border-gray-200 bg-gray-50 p-3 pl-7 rounded-xl text-base md:text-sm focus:bg-white focus:ring-2 focus:ring-red-600 outline-none transition-all"
                      />
                    </div>
...
function StatusToggle({
  ...
  return (
    <button
      onClick={onToggle}
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 ${isActive ? "bg-green-500" : "bg-gray-200"}`}
    >
      <span
